...
def Image_classifier(inputs, scopename, is_training=True, reuse=False):
    with tf.variable_scope(scopename, reuse=reuse):
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected],
            ...
            outputs = slim.fully_connected(net, 100, activation_fn=None, normalizer_fn=None, scope='fco')
    return outputs
                ...
                if self.componentCount == 1:
                    ...
                    for epoch in range(epochs):
                        ...
                        for idx in range(myCount):
                            ...
                            _,_, d_loss = self.sess.run([self.TeacherOptimArr[self.componentCount-1],self.smallVAEArr[self.componentCount-1] ,  self.vaeLoss],
